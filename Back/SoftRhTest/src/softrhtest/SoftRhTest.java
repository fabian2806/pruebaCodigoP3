...
public class SoftRhTest {
    ...
    private static void testModuloPrendas() throws ParseException {
        ...
        // Modificar prenda
        resultado = prendaBO.modificar(5, "Pantalon rasgado", "Pantalon con un estilo rasgado en las piernas", TipoPrenda.Pantalon, null, Talla.S, Genero.Mujer, "Verdiblanco", 80.99, 0.0, 35, 0);
        System.out.println(resultado);
