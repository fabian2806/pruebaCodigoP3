...
BEGIN
	UPDATE usuario SET dni = _dni, nombres = _nombres, apellidos = _apellidos, correo = _correo, contrasenha = _contrasenha WHERE idUsuario = _idTrabajador;
...
BEGIN
	UPDATE usuario SET dni = _dni, nombres = _nombres, apellidos = _apellidos, correo = _correo, contrasenha = _contrasenha WHERE idUsuario = _idCliente;
