...
public class ClienteDAOImp extends DAOImplementacion<Cliente> implements ClienteDAO {
	...
	@Override
	public ArrayList<Cliente> obtenerListarTodos(ResultSet result_set) throws SQLException {
		throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
	}

	@Override
	public Cliente obtenerObtenerPorId(ResultSet result_set) throws SQLException {
		throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
	}
}
